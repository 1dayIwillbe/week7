 ...
 *      2.  Method named getHeight without any parameters, it needs to return the value of height field.
 *      3.  Method named setWidth with one parameter of type double, it needs to set the value of the width
 *          field. If the parameter is less than 0 it needs to set the width field value to 0.
 *      4.  Method named setHeight with one parameter of type double, it needs to set the value of the
 *          height field. If the parameter is less than 0 it needs to set the height field value to 0.
 *      5.  Method named getArea without any parameters, it needs to return the area of the wall.
 */
