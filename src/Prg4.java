...
public class Prg4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter Year(1-9999)           :");
        year = reader.nextInt();
    ...
    public static int getDaysInMonth(int month, int year) {
        if (month < 1 || month > 12) {
            ...
            switch (month) {
                ...
                case 10:
                case 12:
                    System.out.println("31 Days in given month");
                    return 31;

                case 2: {
                    if (isLeapYear(year)) {
                        System.out.println("29 Days in given month");
                        return 29;
                    } else {
                        System.out.println("28 Days in given month");
                        return 28;
                    }
                }
                ...
                case 9:
                case 11:
                    System.out.println("30 Days in given month");
                    return 30;
